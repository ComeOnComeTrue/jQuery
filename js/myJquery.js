(function () {
	...
	jQuery.prototype.myQueue = function () {
		...
		// queue dom {chain: []} 添加队列，或往已有队列添加内容
	...
	jQuery.myDeferred = function () {
		...
		var arr = [
			[
				jQuery.myCallbacks('noce memory'), 'done', 'resolve'
			],[
				jQuery.myCallbacks('noce memory'), 'fail', 'reject'
			],[
